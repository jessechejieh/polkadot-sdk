...
// pallet
// --runtime
// target/release/wbuild/pallet-staking-async-rc-runtime/pallet_staking_async_rc_runtime.compact.compressed.wasm
// --pallet
// pallet_whitelist
// --extrinsic
// *
...
// fake-s
// --output
// ./substrate/frame/staking-async/runtimes/rc/src/weights/
...
impl<T: frame_system::Config> pallet_whitelist::WeightInfo for WeightInfo<T> {
	...
	fn dispatch_whitelisted_call(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `388 + n * (1 ±0)`
		//  Estimated: `3852 + n * (1 ±0)`
		// Minimum execution time: 43_000_000 picoseconds.
		Weight::from_parts(43_000_000, 0)
			.saturating_add(Weight::from_parts(0, 3852))
			// Standard Error: 3
			.saturating_add(Weight::from_parts(994, 0).saturating_mul(n.into()))
	...
	fn dispatch_whitelisted_call_with_preimage(n: u32, ) -> Weight {
		...
		Weight::from_parts(34_763_145, 0)
			.saturating_add(Weight::from_parts(0, 3556))
			// Standard Error: 1
